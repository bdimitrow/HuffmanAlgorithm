...
Transforming a string(storing binary number) into a string(storing a decimal number). Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{string_utils_8h_a94956b3add0021210707c7118df76fc3_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{string_utils_8h_a331f0ff71d04ffc7bc071784035c81d7}\label{string_utils_8h_a331f0ff71d04ffc7bc071784035c81d7}} 
...
Takes a string consisting just of 0s and 1s. Splits the string into substrings of length == 8 and transforms this 8 bits binary number into decimal ones. Returns them as a string. Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=307pt]{string_utils_8h_a331f0ff71d04ffc7bc071784035c81d7_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{string_utils_8h_a331f0ff71d04ffc7bc071784035c81d7_icgraph}
\end{center}
\end{figure}
...
Transforming a string(storing a decimal number) into a string(storing a binary number -\/ 8 bits long). Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{string_utils_8h_a07ac52f96c548c3dd23dc8674429caae_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{string_utils_8h_a95ab5c9436cf673dab142534b3d9d2b8}\label{string_utils_8h_a95ab5c9436cf673dab142534b3d9d2b8}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{string_utils_8h_a95ab5c9436cf673dab142534b3d9d2b8_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{string_utils_8h_aba807da1e1e845d2803bbd298e4c7835_icgraph}
\end{center}
\end{figure}
